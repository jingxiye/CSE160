...
class Vector3 {
    ...
    // used ChatGPT for add, sub, div, and mul
    ...
    static cross(other1, other2) {
        ...
        const a2 = other1.elements[1];
        const a3 = other1.elements[2];
        const b1 = other2.elements[0];
        const b2 = other2.elements[1];
        const b3 = other2.elements[2];
        const i = a2 * b3 - a3 * b2;
        //console.log(`i: ${i}`);
        const j = -1 * (a1 * b3- a3 * b1);
        //console.log(`j: ${j}`);
        const k = (a1 * b2 - a2 * b1);
        //console.log(`k: ${k}`);
    ...
    normalize() { 
        ...
        // used ChatGPT for these few lines
        if (mag != 0) {
